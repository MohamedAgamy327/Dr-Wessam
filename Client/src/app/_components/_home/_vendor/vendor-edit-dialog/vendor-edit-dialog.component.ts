...
export class VendorEditDialogComponent {

  editForm: FormGroup;

  constructor(private formBuilder: FormBuilder, private dialogRef: MatDialogRef<VendorEditDialogComponent>,
  ...
  update() {
    this.repository.put('vendors', this.editForm.value).subscribe(
      (res: any) => {
