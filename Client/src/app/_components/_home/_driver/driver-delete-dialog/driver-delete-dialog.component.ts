...
@Component({
  ...
  styleUrls: ['./driver-delete-dialog.component.css']
})
export class DriverDeleteDialogComponent {

  constructor(private dialogRef: MatDialogRef<DriverDeleteDialogComponent>,
  ...
  confirmDelete(): void {
    this.repository.delete(`drivers/${this.data.id}`).subscribe(
      (res: any) => {
